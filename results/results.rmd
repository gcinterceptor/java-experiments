...
```{r read.nogci}
nogci.low.nostate <- accesslog("1i", "nogci_T40_M65536_W0", REP, WARMUP_SECS, DURATION_SECS)
nogci.low.state <- accesslog("1i", "nogci_T40_M65536_W1024", REP, WARMUP_SECS, DURATION_SECS)
...
```{r read.gci.on}
gci.low.nostate <- accesslog("1i", "gci_T40_M65536_W0", REP, WARMUP_SECS, DURATION_SECS)
gci.low.state <- accesslog("1i", "gci_T40_M65536_W1024", REP, WARMUP_SECS, DURATION_SECS)
